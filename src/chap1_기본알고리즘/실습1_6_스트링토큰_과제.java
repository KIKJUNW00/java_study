...
public class 실습1_6_스트링토큰_과제 {
	...
	private static double[] convertSortToDouble(String[] ssr) {
		double[] doubleArray = new double[ssr.length];
		for (int i = 0; i < ssr.length; i++) {

			doubleArray[i] = Double.parseDouble(ssr[i]);
		}
		// 문자열 배열을 실수 배열로 변환
	...
	// 문자열 배열 출력 함수
	private static void printStringArray(String[] sortedStr) {
