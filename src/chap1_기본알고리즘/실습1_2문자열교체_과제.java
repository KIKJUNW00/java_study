...
public class 실습1_2문자열교체_과제 {
	 ...
	 */
	public static String addSubstring(String s, String addStr) {
		String newStr = s.concat(addStr);
		return newStr;
	}
	public static String replaceString(String newStr, String word, String newWord) {
		String finalStr = newStr.replaceAll(word, newWord); 
		return finalStr;
	}
