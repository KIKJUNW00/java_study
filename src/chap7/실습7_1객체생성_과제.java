...
//            System.out.println("재고가 부족합니다. 남은 재고: " + stockQuantity);
//        } else {
//        	stockQuantity -= quantity; // 재고 감소
//            System.out.println("재고가 " + quantity + "개 감소했습니다. 남은 재고: " + stockQuantity);
//        }
//    }
//
//    // 재고 증가 메소드
//    
//    public void increaseStock(int quantity) { //주문 제품 수량들
//    	
//    }
//
//    // 정보 출력 메소드
